...
const FRAMEWORKS_EN: Framework[] = [
  {
    ...
    items: [
      { id: 'innocent', name: 'Innocent', subtitle: 'innocent', details: [{ label: 'Core Drive', value: 'Be happy' }, { label: 'Motto', value: 'Free to be you and me' }, { label: 'Gift', value: 'Faith and optimism' }, { label: 'Weakness', value: 'Naivety, vulnerability' }] },
      { id: 'orphan', name: 'Orphan', subtitle: 'orphan', details: [{ label: 'Core Drive', value: 'Connect with others' }, { label: 'Motto', value: 'All men and women are created equal' }, { label: 'Gift', value: 'Realism and empathy' }, { label: 'Weakness', value: 'Cynicism' }] },
      { id: 'hero', name: 'Hero', subtitle: 'hero', details: [{ label: 'Core Drive', value: 'Prove worth through courageous acts' }, { label: 'Motto', value: 'Where there\'s a will, there\'s a way' }, { label: 'Gift', value: 'Competence and courage' }, { label: 'Weakness', value: 'Arrogance, aggression' }] },
      { id: 'caregiver', name: 'Caregiver', subtitle: 'caregiver', details: [{ label: 'Core Drive', value: 'Protect others' }, { label: 'Motto', value: 'Love thy neighbour as thyself' }, { label: 'Gift', value: 'Compassion and generosity' }, { label: 'Weakness', value: 'Martyrdom' }] },
      { id: 'explorer', name: 'Explorer', subtitle: 'explorer', details: [{ label: 'Core Drive', value: 'Freedom to explore' }, { label: 'Motto', value: 'Don\'t fence me in' }, { label: 'Gift', value: 'Autonomy and ambition' }, { label: 'Weakness', value: 'Aimless wandering' }] },
      { id: 'rebel', name: 'Rebel', subtitle: 'rebel', details: [{ label: 'Core Drive', value: 'Overturn what doesn\'t work' }, { label: 'Motto', value: 'Rules are made to be broken' }, { label: 'Gift', value: 'Radical freedom and daring' }, { label: 'Weakness', value: 'Destructiveness' }] },
      { id: 'lover', name: 'Lover', subtitle: 'lover', details: [{ label: 'Core Drive', value: 'Intimacy and love' }, { label: 'Motto', value: 'You\'re the only one' }, { label: 'Gift', value: 'Passion and commitment' }, { label: 'Weakness', value: 'Loss of self' }] },
      { id: 'creator', name: 'Creator', subtitle: 'creator', details: [{ label: 'Core Drive', value: 'Create lasting value' }, { label: 'Motto', value: 'If it can be imagined, it can be created' }, { label: 'Gift', value: 'Creativity and imagination' }, { label: 'Weakness', value: 'Perfectionism' }] },
      { id: 'jester', name: 'Jester', subtitle: 'jester', details: [{ label: 'Core Drive', value: 'Live in the moment' }, { label: 'Motto', value: 'You only live once' }, { label: 'Gift', value: 'Joy' }, { label: 'Weakness', value: 'Frivolity' }] },
      { id: 'sage', name: 'Sage', subtitle: 'sage', details: [{ label: 'Core Drive', value: 'Find the truth' }, { label: 'Motto', value: 'The truth will set you free' }, { label: 'Gift', value: 'Wisdom and intelligence' }, { label: 'Weakness', value: 'Disconnection from reality' }] },
      { id: 'magician', name: 'Magician', subtitle: 'magician', details: [{ label: 'Core Drive', value: 'Know the fundamental laws' }, { label: 'Motto', value: 'I make things happen' }, { label: 'Gift', value: 'Insight and vision' }, { label: 'Weakness', value: 'Manipulation' }] },
      { id: 'ruler', name: 'Ruler', subtitle: 'ruler', details: [{ label: 'Core Drive', value: 'Control' }, { label: 'Motto', value: 'Power isn\'t everything, it\'s the only thing' }, { label: 'Gift', value: 'Leadership and responsibility' }, { label: 'Weakness', value: 'Authoritarianism' }] },
    ],
  },
  {
    key: 'schmidt',
    ...
    items: [
      { id: 'boss', name: 'Boss', subtitle: 'boss', details: [{ label: 'Core Drive', value: 'Take control of the situation' }] },
      { id: 'seductress', name: 'Seductress', subtitle: 'seductress', details: [{ label: 'Core Drive', value: 'Attract others' }] },
      { id: 'artist', name: 'Artist', subtitle: 'artist', details: [{ label: 'Core Drive', value: 'Self-expression' }] },
      { id: 'waif', name: 'Waif', subtitle: 'waif', details: [{ label: 'Core Drive', value: 'Find belonging' }] },
      { id: 'free_spirit', name: 'Free Spirit', subtitle: 'free_spirit', details: [{ label: 'Core Drive', value: 'Be unconstrained' }] },
    ],
  },
  {
    key: 'hero_journey',
