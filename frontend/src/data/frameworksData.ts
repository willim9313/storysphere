...
const FRAMEWORKS_EN: RawFramework[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'ordinary_world', name: 'The Ordinary World', subtitle: 'ordinary_world', badge: 'Departure', details: [{ label: 'Description', value: 'The hero is introduced in their everyday environment before the adventure begins. Strengths, weaknesses, and the familiar world are all established here.' }, { label: 'Narrative Function', value: 'Establishes baseline reality, introduces the hero, and creates the contrast that gives the adventure its meaning.' }, { label: 'Typical Position', value: 'Opening act' }] },
      { id: 'call_to_adventure', name: 'The Call to Adventure', subtitle: 'call_to_adventure', badge: 'Departure', details: [{ label: 'Description', value: "Something disrupts the ordinary world — a challenge, problem, or opportunity appears, inviting or forcing the hero to leave their comfort zone." }, { label: 'Narrative Function', value: "The inciting incident that drives the plot. Opens the first major choice: the hero may answer the call or refuse it." }, { label: 'Typical Position', value: 'Early act' }] },
      ...
      { id: 'resurrection', name: 'The Resurrection', subtitle: 'resurrection', badge: 'Return', details: [{ label: 'Description', value: "A final climactic test — the hero is pushed to the limit one last time. All lessons learned are applied. This final 'death and rebirth' purifies the hero before the return." }, { label: 'Narrative Function', value: 'Final proof of transformation. The hero demonstrates they are no longer the person who left the ordinary world.' }, { label: 'Typical Position', value: 'Near-end act' }] },
