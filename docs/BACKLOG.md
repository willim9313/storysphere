...
**背景**: `/ws/chat`、`/ws/tasks/{id}` 目前以任意 `session_id` 字串共用 dict，單機無實害；多使用者或對外部署時，任一 `session_id` 可存取他人對話/任務狀態。
...
**維護者**: William
**最後更新**: 2026-07-08（新增 2026-07-08 安全稽核延後項 B-051 WS 認證 / B-052 log URL 遮罩 / B-053 prod secret 管理，皆 gated 於部署方向）
