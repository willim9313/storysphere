...
### 資料來源（後端）
- [src/storysphere/domain/narrative.py](../../src/storysphere/domain/narrative.py)：`TemporalDisplacement`（L64-74）、`TemporalAnalysis`（L77-112）欄位定義（snake_case）
- [src/storysphere/api/routers/narrative.py:215](../../src/storysphere/api/routers/narrative.py#L215)：result = `TemporalAnalysis.model_dump()`
