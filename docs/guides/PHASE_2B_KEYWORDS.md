...
**路徑**: `backend/storysphere/pipelines/feature_extraction/keyword_extractor.py`
...
**路徑**: `backend/storysphere/pipelines/feature_extraction/keyword_aggregator.py`
...
更新 `backend/storysphere/pipelines/feature_extraction/pipeline.py`，在 embedding 生成後加入 keyword extraction：
...
更新 `backend/storysphere/workflows/ingestion.py`，讓 keyword extraction 在 ingestion 時自動觸發：
...
**路徑**: `backend/storysphere/services/keyword_service.py`
...
| 舊版檔案 | 對應新版 | 說明 |
|----------|---------|------|
| `old_version/backend/storysphere/core/nlp/keyword_extractor.py` | `PKEKeywordExtractor` | KpeTool (MultipartiteRank) |
| `old_version/backend/storysphere/core/nlp/llm_operator.py:169-200` | `LLMKeywordExtractor` | LLM extract_keyword() |
| `old_version/backend/storysphere/pipelines/nlp/keyword_aggregator.py` | `KeywordAggregator` | 聚合策略 + 語義合併 |
| `old_version/backend/storysphere/pipelines/nlp/hierarchical_process.py` | `KeywordAggregator` | chunk→chapter→book |
| `old_version/backend/storysphere/pipelines/feature_extraction/run_llm_tasks.py` | Pipeline 整合 | ingestion 時觸發 |
