...
補全 `backend/storysphere/services/analysis_service.py` 中的 stub 方法：
...
| `top_terms` | KeywordService.get_entity_keywords()（Phase 2b） | 高頻關聯詞 |
...
```python
# backend/storysphere/agents/analysis_agent.py
class AnalysisAgent:
