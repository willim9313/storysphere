...
@pytest.fixture
def delete_client(mock_kg, mock_doc, mock_vector, mock_analysis_agent, mock_chat_agent, mock_cache):
    """client fixture plus the two deps the delete handler needs."""
