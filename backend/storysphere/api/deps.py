...
def get_vector_service():
    from storysphere.services.vector_service import get_vector_service as _get  # noqa: PLC0415
...
def get_summary_service():
    from storysphere.services.summary_service import SummaryService  # noqa: PLC0415
...
def get_extraction_service():
    from storysphere.services.extraction_service import ExtractionService  # noqa: PLC0415
...
def get_analysis_service():
    from storysphere.services.analysis_service import AnalysisService  # noqa: PLC0415
...
def get_keyword_service():
    from storysphere.services.keyword_service import KeywordService  # noqa: PLC0415
...
def get_analysis_agent():
    from storysphere.agents.analysis_agent import AnalysisAgent  # noqa: PLC0415
...
def get_tension_service():
    from storysphere.services.tension_service import TensionService  # noqa: PLC0415
...
def get_narrative_service():
    from storysphere.services.narrative_service import NarrativeService  # noqa: PLC0415
...
def get_global_timeline_service():
    from storysphere.services.global_timeline_service import GlobalTimelineService  # noqa: PLC0415
...
def get_timeline_agent():
    from storysphere.agents.timeline_agent import TimelineAgent  # noqa: PLC0415
...
def get_temporal_pipeline():
    from storysphere.pipelines.temporal_pipeline import TemporalPipeline  # noqa: PLC0415
...
def get_symbol_graph_service():
    from storysphere.services.symbol_graph_service import SymbolGraphService  # noqa: PLC0415
...
def get_symbol_analysis_service():
    from storysphere.services.symbol_analysis_service import SymbolAnalysisService  # noqa: PLC0415
...
def get_epistemic_state_service():
    from storysphere.services.epistemic_state_service import EpistemicStateService  # noqa: PLC0415
...
def get_voice_profiling_service():
    from storysphere.services.voice_profiling_service import VoiceProfilingService  # noqa: PLC0415
...
def get_link_prediction_store():
    from storysphere.config.settings import get_settings  # noqa: PLC0415
    from storysphere.services.link_prediction_store import LinkPredictionStore  # noqa: PLC0415
...
def get_link_prediction_service():
    from storysphere.services.link_prediction_service import LinkPredictionService  # noqa: PLC0415
...
def get_faction_service():
    from storysphere.services.faction_service import FactionService  # noqa: PLC0415
