...
class YakeKeywordExtractor(BaseKeywordExtractor):
    ...
    async def extract(
        ...
        from storysphere.core.language_detection import to_yake_language  # noqa: PLC0415
...
class LLMKeywordExtractor(BaseKeywordExtractor):
    ...
    def _parse_response(content: str) -> dict[str, float]:
        ...
        from storysphere.core.utils.output_extractor import extract_json_from_text  # noqa: PLC0415
