...
class Relation(BaseModel):
    ...
    valid_to_chapter: int | None = None   # exclusive; None = still active at end of book
    # Story-chronology mode: filled in after TemporalPipeline runs
    valid_from_chron_index: int | None = None
    valid_to_chron_index: int | None = None  # exclusive
