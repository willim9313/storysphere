...
from storysphere.tools.base import format_entity, format_tool_output
from storysphere.tools.schemas import ExtractEntitiesInput
...
class ExtractEntitiesFromTextTool(BaseTool):
    ...
    def _resolve_service(self):
        ...
        from storysphere.services.extraction_service import ExtractionService
