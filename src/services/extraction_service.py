...
class ExtractionService:
    ...
    async def extract_entities(self, text: str, chapter_number: int) -> list[Entity]:
        ...
        raw_list = await self._call_entity_llm(text)
    ...
    async def extract_relations(
        ...
        raw = await self._call_relation_llm(text, entity_names)
    ...
    async def _call_entity_llm(self, text: str) -> _EntityList:
