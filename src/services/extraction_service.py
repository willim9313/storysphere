...
class ExtractionService:
    ...
    @_lf_observe(name="extract.entities", as_type="chain", capture_input=False, capture_output=False)
    async def extract_entities(
        ...
        """
        _lf_update_span(metadata={"chapter": chapter_number, "text_len": len(text)})
    ...
    @_lf_observe(name="extract.relations", as_type="chain", capture_input=False, capture_output=False)
    async def extract_relations(
        ...
        """
        _lf_update_span(metadata={"chapter": chapter_number, "entity_count": len(entities)})
