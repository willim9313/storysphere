"""Tension analysis endpoints — B-027.
...
from api.deps import KGServiceDep, TensionServiceDep
from api.schemas.common import TaskStatus
from api.schemas.tension import GroupTensionLinesRequest, TensionLineReviewRequest
