...
class EnglishBaseTemplates:
    ...
    GENERAL_SYSTEM_PROMPT = """You are a professional text analysis maestro, skilled in understanding and analyzing text content. Please carefully read the user's requirements and provide accurate, helpful responses."""
